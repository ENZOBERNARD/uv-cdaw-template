                ...
                <div class="d-inline collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto">
                       ...
                       <!-- <li class="nav-item">
                        ...
                        <li style="margin-left:80px;width:50px; display: inline-block!important;" class="nav-item"><a class="nav-link" href="../resources/views/login.blade.php">Se&nbsp;connecter</a></li>
                    </ul>
                </div>
            </div>
        </nav><?php /**PATH /var/www/html/catalogue/resources/views/elements/header.blade.php ENDPATH**/ ?>