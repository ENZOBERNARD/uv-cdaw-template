...
<!-- Masthead-->
<header class="masthead" style="padding-top: 200px;">
        ...
        <section class="about-section text-center" id="about">
            <div class="container px-4 px-lg-5">
                ...
                <img class="img-fluid" src="../resources/assets/ipad.png" alt="..." />
            </div>
        </section>
        <!-- Projects-->
        <section class="projects-section bg-light" id="projects">
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-0 mb-4 mb-lg-5 align-items-center">
                    <div class="col-xl-8 col-lg-7"><img class="img-fluid mb-3 mb-lg-0" src="../resources/assets/bg-masthead.jpg" alt="..." /></div>
                ...
                <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
                    <div class="col-lg-6"><img class="img-fluid" src="../resources/assets/demo-image-01.jpg" alt="..." /></div>
                    <div class="col-lg-6">
                ...
                <div class="row gx-0 justify-content-center">
                    <div class="col-lg-6"><img class="img-fluid" src="../resources/assets/demo-image-02.jpg" alt="..." /></div>
